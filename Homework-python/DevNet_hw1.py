...
def test_function(a,b):
    ...
    return result #it needed this return line#
...
def test_function2(a,b):
    ...
    """
    result = a*b
    print('Result: {0}'.format(result))  #it needed these two lines to be flipped"
    return result
...
class Pizza():
    def __init__(self, size, model, sauce):
        self.size = size
        self.model = model
        self.sauce = sauce
        
pizza1 = Pizza('50cm', 'Quattro Formaggi', 'olive oil')
print(pizza1)
print(pizza1.size)
print(pizza1.model)
print(pizza1.sauce)
pizza2 = Pizza('32cm', 'Prosciutto', 'garlic sauce')
print(pizza2)
print(pizza2.size)
print(pizza2.model)
print(pizza2.sauce)
pizza3 = Pizza('40cm', 'Margheritta', 'tomato sauce')
print(pizza3)
print(pizza3.size)
print(pizza3.model)
print(pizza3.sauce)
...
def vaccine_classified(a):
    result = 2022 - int(a)
    if (result > 80):
      print ("You are classified for COVID vaccine")
    assert result > 80, "You are not classified for COVID vaccine"

#vaccine_classified(1942)
def main():
    year = input("Enter your birth year: ")
    vaccine_classified(year)
